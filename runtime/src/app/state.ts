...
export type DensityJSON = { id: string; type: "density"; chart: string; extent: number[]; textures: Record<string, string>; metric: string; surface?: boolean; points?: number[][]; view?: number; curvature?: boolean };
